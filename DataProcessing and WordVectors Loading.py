...
model.compile(optimizer=keras.optimizers.Adam(lr = 0.003), loss='categorical_crossentropy' )
model.fit( [context_sequences, question_sequences], one_hot_targets, batch_size=128, epochs=EPOCHS,
          validation_split = 0.2)
